...
class Test_pareto(): 
    ...
    def test_some_refinement(self, descending, factor, ndist): 
        ...
        # Extreme tail condition
        should_fit = descending ^ (factor == 1)  

#         print(f"Testing: descending={descending}, factor={factor}, should_fit={should_fit}, \
# P_emp={P_emp}, P={P}, apar={apar}, kpar={kpar}, upar={upar}")
        ...
        if should_fit:
            ...
            # Should gracefully fall back to the empirical p-value
            np.testing.assert_allclose(P, P_emp)
